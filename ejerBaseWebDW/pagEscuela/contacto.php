...
<head>
   ...
   <link rel="stylesheet" href="../estilos/main_contacto.css"> 
...
<body>
    ...
    <header class="site-header inicio ">
        <div class="contenedor2 contenido-header">
            <div class="barra">
                <a href="/">
                    <img src="../imgEscuela/logo.png" alt="Logotipo de ANCA" width="200px" height="180px">
                </a>
    ...
    <div class="container">
        ...
        <form class="form_reg" action="conectar.php" method="post">
